...
const TRANSLATIONS: Record<AppLocale, Record<string, string>> = {
  en: {
    ...
    'operations.saveEdit': 'Save changes',
    'operations.saving': 'Saving...',
    'operations.editDialogTitle': 'Edit activity',
    'operations.editLabel': 'Edit',
    'operations.deleteLabel': 'Delete',
    'operations.deleteConfirm': 'Delete this entry?',
    'operations.deleteYes': 'Yes, delete',
    'operations.deleteNo': 'Cancel',
  ...
  uk: {
    ...
    'operations.saveEdit': 'Зберегти зміни',
    'operations.saving': 'Збереження...',
    'operations.editDialogTitle': 'Редагувати запис',
    'operations.editLabel': 'Редагувати',
    'operations.deleteLabel': 'Видалити',
    'operations.deleteConfirm': 'Видалити цей запис?',
    'operations.deleteYes': 'Так, видалити',
    'operations.deleteNo': 'Скасувати',
