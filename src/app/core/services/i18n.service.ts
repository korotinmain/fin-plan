...
const TRANSLATIONS: Record<AppLocale, Record<string, string>> = {
  en: {
    ...
    'operations.filterAllTypes': 'All types',
    ...
    'operations.type.transfer': 'Withdrawal',
    ...
    'operations.activity.transferTitle': 'Withdrawal',
  ...
  uk: {
    ...
    'operations.filterAllTypes': 'Усі типи',
    ...
    'operations.type.transfer': 'Зняття',
    ...
    'operations.activity.transferTitle': 'Зняття',
