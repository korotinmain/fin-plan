...
const TRANSLATIONS: Record<AppLocale, Record<string, string>> = {
  en: {
    ...
    'goal.title': 'House Target',
    'goal.subtitle': 'Your primary savings goal',
    'goal.edit': 'Edit goal',
    'goal.updateTitle': 'Update target',
    'goal.setTitle': 'Set your target',
    'goal.description':
      'Define the total price of the property you are saving toward. All progress will be tracked in USD.',
    ...
    'goal.saving': 'Saving...',
    'goal.updateCta': 'Update goal',
    'goal.saveCta': 'Save goal',
    'goal.cancel': 'Cancel',
    'goal.target': 'Target',
    'goal.progressSaved': '0% saved',
    'goal.progressNote': 'Add currency holdings to track progress',
  ...
  uk: {
    ...
    'goal.title': 'Ціль на дім',
    'goal.subtitle': 'Ваша основна ціль заощаджень',
    'goal.edit': 'Редагувати ціль',
    'goal.updateTitle': 'Оновити ціль',
    'goal.setTitle': 'Встановіть ціль',
    'goal.description':
      'Вкажіть повну вартість нерухомості, на яку ви заощаджуєте. Увесь прогрес відстежується в USD.',
    'goal.targetAmount': 'Цільова сума',
    ...
    'goal.updateCta': 'Оновити ціль',
    'goal.saveCta': 'Зберегти ціль',
    'goal.cancel': 'Скасувати',
    'goal.target': 'Ціль',
    'goal.progressSaved': '0% збережено',
    'goal.progressNote': 'Додайте валютні залишки, щоб відстежувати прогрес',
    'goal.totalSaved': 'Усього збережено',
