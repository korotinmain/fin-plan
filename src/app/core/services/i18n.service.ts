...
const TRANSLATIONS: Record<AppLocale, Record<string, string>> = {
  en: {
    ...
    'shell.nav.exchangeOps': 'Exchange & Ops',
    ...
    'dashboard.eyebrow': 'House Readiness',
    'dashboard.heroTitle': 'Executive Dashboard',
    'dashboard.heroSubtitle':
      'Your full picture: own savings, borrowed support, source composition, and FX drag.',
    'dashboard.reviewPlan': 'Review plan',
    'dashboard.targetHousePrice': 'Target House Price',
    'dashboard.ownSavings': 'Own Savings',
    'dashboard.expectedBorrowedFunds': 'Expected Borrowed Funds',
    'dashboard.stillMissing': 'Still Missing',
    'dashboard.totalReadinessProgress': 'Total readiness progress',
    'dashboard.activeSourcesHint': 'Across {{value}} active money sources',
    'dashboard.borrowedSupport': 'Borrowed support',
    'dashboard.borrowedSupportHint': 'Converted live from EUR / UAH / USD',
    'dashboard.fxLosses': 'FX losses',
    'dashboard.fxLossesHint': 'Spread and conversion drag so far',
    'dashboard.estimatedCompletion': 'Estimated completion',
    'dashboard.goalReached': 'Goal reached',
    'dashboard.monthsShort': 'mo',
    'dashboard.estimatedCompletionHint': 'At current pace + planned support',
    'dashboard.readinessGrowth': 'Readiness growth',
    'dashboard.readinessGrowthHint':
      'Shows how your capital base is moving toward the house target.',
    'dashboard.capitalComposition': 'Capital composition',
    'dashboard.capitalCompositionHint': 'Own savings vs expected support.',
    'dashboard.totalReadyCapital': 'Total ready capital',
    'dashboard.remainingGap': 'Remaining gap',

    'route.dashboardTitle': 'Dashboard — FinPlan',
    'route.sourcesTitle': 'Sources — FinPlan',
    'route.expectedFundsTitle': 'Expected Funds — FinPlan',
    'route.exchangeOpsTitle': 'Exchange & Ops — FinPlan',
    ...
    'expectedFunds.searchPlaceholder': 'Search source or person',
    ...
    'expectedFunds.errors.invalidForm': 'Fill in all fields and enter an amount above zero.',
    ...
    'operations.title': 'Exchange & Activity',
    'operations.subtitle':
      'Track movement between sources, preserve rate context, and make FX drag explicit.',
    'operations.recordExchange': 'Record exchange',
    'operations.impactTitle': 'Exchange impact',
    'operations.impactSubtitle':
      'Losses caused by buy/sell spread should be visible, not hidden inside balances.',
    'operations.cumulativeFxLoss': 'Cumulative FX loss',
    'operations.cumulativeFxLossHint': 'Spread + unfavorable buy rate',
    'operations.largestRecentLoss': 'Largest recent loss',
    'operations.noLossesTracked': 'No losses tracked yet',
    ...
    'operations.emptySubtitle':
      'Use the top-right action to record an exchange, transfer, or income event.',
    'operations.dialogTitle': 'Record operation',
    'operations.dialogSubtitle':
      'Every entry updates tracked balances and keeps the movement visible in the log.',
  ...
  uk: {
    ...
    'shell.nav.exchangeOps': 'Курс і операції',
    ...
    'dashboard.eyebrow': 'Готовність до покупки',
    'dashboard.heroTitle': 'Executive Dashboard',
    'dashboard.heroSubtitle':
      'Повна картина: власні заощадження, зовнішня підтримка, структура джерел і валютні втрати.',
    'dashboard.reviewPlan': 'Переглянути план',
    'dashboard.targetHousePrice': 'Цільова вартість житла',
    'dashboard.ownSavings': 'Власні заощадження',
    'dashboard.expectedBorrowedFunds': 'Очікувані позикові кошти',
    'dashboard.stillMissing': 'Ще бракує',
    'dashboard.totalReadinessProgress': 'Загальний прогрес готовності',
    'dashboard.activeSourcesHint': 'Через {{value}} активні джерела коштів',
    'dashboard.borrowedSupport': 'Зовнішня підтримка',
    'dashboard.borrowedSupportHint': 'Конвертовано з EUR / UAH / USD',
    'dashboard.fxLosses': 'Валютні втрати',
    'dashboard.fxLossesHint': 'Спред і конверсійний драг на поточний момент',
    'dashboard.estimatedCompletion': 'Орієнтовне завершення',
    'dashboard.goalReached': 'Ціль досягнуто',
    'dashboard.monthsShort': 'міс',
    'dashboard.estimatedCompletionHint': 'За поточного темпу та запланованої підтримки',
    'dashboard.readinessGrowth': 'Зростання готовності',
    'dashboard.readinessGrowthHint': 'Показує, як капітальна база наближається до цілі покупки.',
    'dashboard.capitalComposition': 'Структура капіталу',
    'dashboard.capitalCompositionHint': 'Власні заощадження проти очікуваної підтримки.',
    'dashboard.totalReadyCapital': 'Загальний готовий капітал',
    'dashboard.remainingGap': 'Залишковий розрив',

    'route.dashboardTitle': 'Панель — FinPlan',
    'route.sourcesTitle': 'Джерела — FinPlan',
    'route.expectedFundsTitle': 'Очікувані кошти — FinPlan',
    'route.exchangeOpsTitle': 'Курс і операції — FinPlan',
    ...
    'expectedFunds.searchPlaceholder': 'Пошук джерела або людини',
    ...
    'expectedFunds.errors.invalidForm': 'Заповніть усі поля та введіть суму, більшу за нуль.',
    ...
    'operations.eyebrow': 'Операції',
    'operations.title': 'Курс і активність',
    'operations.subtitle':
      'Відстежуйте рух між джерелами, зберігайте контекст курсу й робіть FX-драг явним.',
    'operations.recordExchange': 'Записати обмін',
    'operations.impactTitle': 'Вплив обміну',
    'operations.impactSubtitle':
      'Втрати через спред купівлі/продажу мають бути видимими, а не захованими в балансах.',
    'operations.cumulativeFxLoss': 'Сукупні FX-втрати',
    'operations.cumulativeFxLossHint': 'Спред + невигідний курс купівлі',
    'operations.largestRecentLoss': 'Найбільша недавня втрата',
    'operations.noLossesTracked': 'Поки що втрати не зафіксовано',
    ...
    'operations.emptySubtitle':
      'Скористайтеся кнопкою праворуч угорі, щоб записати обмін, переказ або дохід.',
    'operations.dialogTitle': 'Записати операцію',
    'operations.dialogSubtitle':
      'Кожен запис оновлює відстежувані баланси й зберігає рух видимим у журналі.',
